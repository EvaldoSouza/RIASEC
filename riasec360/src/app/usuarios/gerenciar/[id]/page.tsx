...
import { AplicacoesRespondidasPeloUsuario } from "@/actions/aplicacaoActions";
import styles from "./UserPage.module.css";
import InfosUsuarioCard from "./infosUsuarioCard";
import TestesCard from "./testesCard";
...
const UserPage = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <TestesCard answeredApplications={answeredApplications} />
    </div>
  );
};
